...
class Student:
    def __init__(self, student_id, first_name, email, password, subjects):
    ...
    def __str__(self):
        return f"Student ID: {self.student_id}, Name: {self.first_name} , Email: {self.email}, Subjects : {self.subjects}"
    
    def remove_subject(self, subject_id):
        self.subjects = [subject for subject in self.subjects if subject.subject_id != subject_id]

    def to_dict(self): #object to dictionary(json) conversion
        return {
